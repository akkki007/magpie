...
| Reconciliation | **Built through R3.** An 11,258-record synthetic batch with a labelled answer key, ingestion, a deterministic matcher and a scoreboard: 100% precision, 0% false matches, 98.6% match rate, no model involved. The 1.4% is the six links deliberately left for judgement. `bun run recon:eval`. `docs/recon-plan.md`. |
