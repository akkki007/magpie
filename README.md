...
| Reconciliation | **Built through R3.** An 11,258-record synthetic batch with a labelled answer key, ingestion, a deterministic matcher and a scoreboard: 100% precision, 0% false matches, 100% match rate on all three lanes, no model involved. `bun run recon:eval`. `docs/recon-plan.md`. |
