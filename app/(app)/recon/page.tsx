...
import { UploadStatement } from "@/components/recon/upload-statement";
import { readRunReport } from "@/lib/recon/report";
import { archiveEnabled } from "@/lib/recon/s3";
...
export default async function ReconPage() {
  ...
  return (
    ...
    >
      ...
      {/* Only where a bucket is configured — a fresh clone has no AWS account, and a panel
          that can only answer "not configured" is worse than no panel. */}
      {archiveEnabled() && <UploadStatement />}
