  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-3 right-3 grid h-7 w-7 place-items-center rounded-control text-ink-faint opacity-100 transition-opacity hover:bg-hover hover:text-ink focus-visible:opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
      >
